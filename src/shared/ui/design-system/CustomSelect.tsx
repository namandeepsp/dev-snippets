	...
	return (
		...
		>
			{searchable ? (
				<div
					className={cn(
						'flex h-11 w-full items-center justify-between rounded-xl border border-gray-200 bg-white px-3 text-left text-sm transition-all',
						'focus-within:outline-none focus-within:ring-4 focus-within:ring-blue-500/20',
					...
					{filteredOptions.map((option, index) => (
						<button
							...
							className={cn(
								...
								internalValue && option.value === internalValue
									...
									: highlightedIndex === index && !internalValue
