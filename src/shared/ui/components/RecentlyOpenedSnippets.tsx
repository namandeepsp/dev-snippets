...
import { RecentSnippet } from "@/features/snippets/ui/recent-snippets"
...
const RecentlyOpenedSnippets = ({ displayedRecent, onClose, handleDeleteRecent, handleClearRecent }: Props) => {
    return (
        <div>
