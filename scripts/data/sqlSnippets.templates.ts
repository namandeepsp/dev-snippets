...
export const SQL_SNIPPET_TEMPLATES: SnippetTemplate[] = [
  {
    ...
    description: 'Simple SELECT query to retrieve all columns from a table. Usage: SELECT * FROM users',
  ...
  },
  {
    ...
    description: 'Filter results based on conditions. Usage: SELECT * FROM users WHERE age > 18',
  ...
  },
  {
    ...
    description: 'Combine data from multiple tables using INNER JOIN. Usage: Join users with orders',
...
WHERE o.total > 100;`,
  ...
  },
  {
    ...
    description: 'Left join to include unmatched rows from left table. Usage: Find users without orders',
...
HAVING COUNT(o.id) = 0;`,
  ...
  },
  {
    ...
    description: 'Use COUNT, SUM, AVG, MIN, MAX for data aggregation. Usage: Calculate statistics',
    code: `SELECT 
...
FROM users;`,
  ...
  },
  {
    ...
    description: 'Group results and filter groups using HAVING clause. Usage: Find departments with high salaries',
...
ORDER BY avg_salary DESC;`,
  ...
  },
  {
    ...
    description: 'Sort results and limit number of rows returned. Usage: Get top 10 products',
...
LIMIT 10;`,
  ...
  },
  {
    ...
    description: 'Conditional logic in SQL queries. Usage: Categorize users by age groups',
...
FROM users;`,
  ...
  },
  {
    ...
    description: 'Use subquery to filter results. Usage: Find users who made purchases',
    code: `SELECT * FROM users
WHERE id IN (
...
VALUES ('John Doe', 'john@example.com', 28, NOW());`,
  ...
  },
  {
    ...
    description: 'Insert multiple records in one statement. Usage: Bulk insert users',
...
WHERE last_login < DATE_SUB(NOW(), INTERVAL 90 DAY);`,
  ...
  },
  {
    ...
    description: 'Remove records matching a condition. Usage: Delete inactive users',
...
WHERE status = 'inactive' AND updated_at < DATE_SUB(NOW(), INTERVAL 1 YEAR);`,
  ...
  {
    title: 'UNION Query',
    description: 'Combine results from multiple SELECT statements. Usage: Merge data from different tables',
...
ORDER BY name;`,
  ...
  },
  {
    ...
    description: 'Calculate running totals and rankings. Usage: Rank employees by salary',
...
FROM employees;`,
  ...
  },
  {
    ...
    description: 'Create temporary named result sets. Usage: Simplify complex queries',
...
ORDER BY created_at DESC;`,
  ...
  },
  {
    ...
    description: 'Create indexes to speed up queries. Usage: Index frequently searched columns',
